...
To set the size of the items, you can use the `basis` utility class on the `<Carousel.Content.Item />`.
...
<Carousel>
  <Carousel.Content>
    <Carousel.Content.Item className="basis-1/3">...</Carousel.Content.Item>
    <Carousel.Content.Item className="basis-1/3">...</Carousel.Content.Item>
    <Carousel.Content.Item className="basis-1/3">...</Carousel.Content.Item>
  </Carousel.Content>
</Carousel>
...
<Carousel>
  <Carousel.Content>
    <Carousel.Content.Item className="md:basis-1/2 lg:basis-1/3">...</Carousel.Content.Item>
    <Carousel.Content.Item className="md:basis-1/2 lg:basis-1/3">...</Carousel.Content.Item>
    <Carousel.Content.Item className="md:basis-1/2 lg:basis-1/3">...</Carousel.Content.Item>
  </Carousel.Content>
</Carousel>
...
To set the spacing between the items, we use a `pl-[VALUE]` utility on the `<Carousel.Content.Item />` and a negative `-ml-[VALUE]` on the `<Carousel.Content />`.
...
<Carousel>
  <Carousel.Content className="-ml-4">
    <Carousel.Content.Item className="pl-4">...</Carousel.Content.Item>
    <Carousel.Content.Item className="pl-4">...</Carousel.Content.Item>
    <Carousel.Content.Item className="pl-4">...</Carousel.Content.Item>
  </Carousel.Content>
</Carousel>
...
<Carousel>
  <Carousel.Content className="-ml-2 md:-ml-4">
    <Carousel.Content.Item className="pl-2 md:pl-4">...</Carousel.Content.Item>
    <Carousel.Content.Item className="pl-2 md:pl-4">...</Carousel.Content.Item>
    <Carousel.Content.Item className="pl-2 md:pl-4">...</Carousel.Content.Item>
  </Carousel.Content>
</Carousel>
