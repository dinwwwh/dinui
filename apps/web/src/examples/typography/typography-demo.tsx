export default function TypographyDemo() {
  return (
    <div>
      ...
      <h2 className="mt-10 scroll-m-20 border-b border-wgray-200 dark:border-wgray-800 pb-2 text-3xl font-semibold tracking-tight transition-colors first:mt-0">
        The King's Plan
      </h2>
      <p className="leading-7 [&:not(:first-child)]:mt-6">
      ...
      <div className="my-6 w-full overflow-y-auto">
        <table className="w-full">
          <thead>
            <tr className="m-0 border-t border-wgray-200 dark:border-wgray-800 p-0 even:bg-wgray-100 dark:even:bg-wgray-900">
              <th className="border border-wgray-200 dark:border-wgray-800 px-4 py-2 text-left font-bold [&[align=center]]:text-center [&[align=right]]:text-right">
                King's Treasury
              </th>
              <th className="border border-wgray-200 dark:border-wgray-800 px-4 py-2 text-left font-bold [&[align=center]]:text-center [&[align=right]]:text-right">
                People's happiness
          ...
          <tbody>
            <tr className="m-0 border-t border-wgray-200 dark:border-wgray-800 p-0 even:bg-wgray-100 dark:even:bg-wgray-900">
              <td className="border border-wgray-200 dark:border-wgray-800 px-4 py-2 text-left [&[align=center]]:text-center [&[align=right]]:text-right">
                Empty
              </td>
              <td className="border border-wgray-200 dark:border-wgray-800 px-4 py-2 text-left [&[align=center]]:text-center [&[align=right]]:text-right">
                Overflowing
