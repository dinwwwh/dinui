              ...
              {options.map((option) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={cn(
                        'mr-2 flex h-4 w-4 items-center justify-center rounded-sm border border-gray-900 dark:border-gray-50',
                        isSelected
                          ? 'bg-gray-900 dark:bg-gray-50 text-gray-900 dark:text-gray-50'
