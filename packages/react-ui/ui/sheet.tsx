...
export const sheet = tv({
  ...
  variants: {
    side: {
      top: 'inset-x-0 top-0 border-gray-200 dark:border-gray-700 border-b data-[state=closed]:slide-out-to-top data-[state=open]:slide-in-from-top',
      bottom:
        'inset-x-0 bottom-0 border-gray-200 dark:border-gray-700 border-t data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom',
      left: 'inset-y-0 left-0 h-full w-3/4 border-gray-200 dark:border-gray-700 border-r data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left sm:max-w-sm',
      right:
        'inset-y-0 right-0 h-full w-3/4 border-gray-200 dark:border-gray-700 border-l data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right sm:max-w-sm',
    },
  },
  defaultVariants: {
    side: 'right',
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Title
    ref={ref}
    className={twMerge('text-lg font-semibold text-gray-950 dark:text-gray-50', className)}
    {...props}
  />
))
