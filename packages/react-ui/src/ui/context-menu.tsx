...
>(({ className, ...props }, ref) => (
  <ContextMenuPrimitive.Portal>
    <ContextMenuPrimitive.Content
      ref={ref}
      className={twMerge(
        'z-50 min-w-[8rem] overflow-hidden rounded-md border border-wgray-200 dark:border-wgray-800 bg-white p-1 text-wgray-950 shadow-md data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2  dark:bg-wgray-950 dark:text-wgray-50',
        className,
      )}
      {...props}
    />
...
>(({ className, inset, ...props }, ref) => (
  <ContextMenuPrimitive.Label
    ref={ref}
    className={twMerge(
      'px-2 py-1.5 text-sm font-semibold text-wgray-950 dark:text-wgray-50',
      inset && 'pl-8',
      className,
    )}
    {...props}
...
>(({ className, ...props }, ref) => (
  <ContextMenuPrimitive.Separator
    ref={ref}
    className={twMerge('-mx-1 my-1 h-px bg-wgray-200 dark:bg-wgray-800', className)}
    {...props}
  />
))
